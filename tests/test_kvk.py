...
VOORBEELD_PROFIEL = {
    ...
    "handelsnamen": [
        ...
        {"naam": "Voorbeeld Tweewielers Noord", "volgorde": 1},
    ],
    "sbiActiviteiten": [
    ...
    "_embedded": {
        ...
        "hoofdvestiging": {
            ...
            "kvkNummer": "99999999",
            "eersteHandelsnaam": "Voorbeeld Tweewielers",
            ...
            "websites": ["www.voorbeeld-tweewielers.example"],
        },
    },
}
...
def test_afgeschermd_adres_wordt_niet_alsnog_samengesteld():
    ...
    profiel = {"_embedded": {"hoofdvestiging": {"adressen": [{
        ...
        "straatnaam": "Dorpsstraat", "huisnummer": 1, "plaats": "Voorbeeldstad",
    }]}}}
...
def test_een_bedrijf_met_twee_records_wordt_een_regel():
    gegroepeerd = groepeer_resultaten(ZOEKRESULTAAT_DUBBEL)
...
def test_de_regel_met_het_adres_blijft_over():
    ...
    regel = groepeer_resultaten(ZOEKRESULTAAT_DUBBEL)[0]
    assert regel["type"] == "hoofdvestiging"
    assert regel["vestigingsnummer"] == "000088888888"
    assert regel["adres"]["binnenlandsAdres"]["plaats"] == "Voorbeeldstad"
...
def test_groeperen_maakt_directe_opvraging_weer_mogelijk():
    ...
    assert len(ZOEKRESULTAAT_DUBBEL) == 2
    assert len(groepeer_resultaten(ZOEKRESULTAAT_DUBBEL)) == 1
...
def test_twee_resultaten_met_hetzelfde_kvk_nummer_geven_verschillende_sleutels():
    ...
    sleutels = [regel_sleutel(r, i) for i, r in enumerate(ZOEKRESULTAAT_DUBBEL)]
...
def test_sleutels_zijn_uniek_over_een_volle_pagina_resultaten():
    ...
    resultaten = (
        [{"kvkNummer": "88888888", "type": "rechtspersoon"}] * 3
